...
y.int.max <- countData$y[countData$variable=="Other"]
y.other.min <- countData$y[countData$variable=="Other"]
...
countData <- countData %>%
  mutate(variableSub=ifelse(column=="Left" & y > y.age.min & y < y.age.max))
